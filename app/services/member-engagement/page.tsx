...
export const metadata: Metadata = {
  ...
  description: 'Expert member engagement services for associations and membership organisations. Community building, events, and personalised member journeys.',
  alternates: {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            Member <span className="text-purple-400">Engagement</span>
          </h1>
      ...
      <section className="py-16 px-4 bg-slate-800/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
            Engaged members are 3x more likely to renew, 4x more likely to refer others, and contribute more to your community.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Community Building', desc: 'Forums, groups, and networking opportunities that connect members.' },
              { title: 'Event Programming', desc: 'Webinars, conferences, and local meetups that drive participation.' },
              { title: 'Content Strategy', desc: 'Resources, guides, and tools that members actually use.' },
              { title: 'Gamification', desc: 'Recognition programmes, badges, and incentives that motivate engagement.' },
              { title: 'Personalisation', desc: 'Tailored communications and journeys based on member interests.' },
              { title: 'Member Champions', desc: 'Identify and empower your most engaged members as advocates.' },
            ].map((item, i) => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-slate-400">Increase in engagement</p>
            </div>
            <div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-400 mb-8">Book a free consultation to discuss your engagement challenges.</p>
